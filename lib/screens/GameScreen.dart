...
class GameScreen extends StatelessWidget {
  ...
  Widget _buildQuickPlayGames(BuildContext context) {
    ...
    return GridView.builder(
      shrinkWrap:
          true, // co lại theo nội dung nó chứa thay vì chiếm toàn bộ height
      physics:
          const NeverScrollableScrollPhysics(), // Tắt scroll riêng, vì GridView nằm trong SingleChildScrollView bên ngoài
      padding: const EdgeInsets.symmetric(horizontal: 16), // Lề trái/phải
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 2, // Số cột = 2
        childAspectRatio:
            1.1, // Tỉ lệ khung (width/height). >1: ngang rộng hơn cao
      ...
      itemBuilder: (ctx, i) {
        return InkWell(
          // InkWell = opTap + hiệu ứng ripple   để bắt sk
          onTap: () {
            Navigator.push(
              context,
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: [
                  (games[i]['color'] as Color).withAlpha(60),
                  (games[i]['color'] as Color).withAlpha(30),
                ],
            ...
            child: Column(
              mainAxisAlignment:
                  MainAxisAlignment.center, // Căn center theo chiều dọc
              children: [
                Icon(
