    ...
    final games = [
      {
        ...
        'description':
            'Tic Tac Toe là trò chơi đơn giản, nơi bạn cần xếp 3 ký tự liên tiếp để thắng.',
        'instructions':
            'Chọn ô để đánh dấu X hoặc O. Người chơi nào xếp được 3 ký tự liên tiếp trước sẽ thắng, bạn cũng có thể chặn người chơi khác lại bằng dấu của mình.',
      },
      {
        'name': 'Sudoku',
        ...
        'description':
            'Sudoku là trò chơi giải đố với bảng 9x9, nơi bạn cần điền số từ 1 đến 9.',
        'instructions':
            'Điền số vào các ô trống sao cho mỗi hàng, cột và ô 3x3 không có số trùng lặp.',
      },
      {
        'name': 'Rắn Săn Mồi',
        'icon': Icons.widgets,
        ...
        'description':
            'Nhiệm vụ của bạn là giúp con rắn thu nhập thức ăn, và giữ cho nó sống lâu nhất có thể',
        'instructions':
            'Điều khiển rắn thu nhập thức ăn bằng các phím mũi tên. Tránh va vào tường hoặc chính mình.',
      },
    ];
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [
            (game['color'] as Color).withAlpha(60),
            (game['color'] as Color).withAlpha(30),
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
      ...
      child: Stack(
        children: [
          Positioned.fill(
            child: Opacity(
              opacity: 0.1,
              child: Image.asset(game['image'] as String, fit: BoxFit.cover),
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(20),
            child: Row(
              ...
              children: [
                ...
                Icon(game['icon'] as IconData, size: 50, color: Colors.white),
              ],
            ),
          ),
        ],
